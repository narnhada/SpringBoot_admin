...
import com.example.test.practice.model.network.request.ItemApiRequest;
import com.example.test.practice.model.network.response.ItemApiResponse;
import com.example.test.practice.repository.ItemRepository;
import com.example.test.practice.repository.PartnerRepository;
...
public class ItemApiLogicService implements CrudInterface<ItemApiRequest, ItemApiResponse> {
    ...
    @Autowired
    private PartnerRepository partnerRepository; // partner id 를 가져오기 위해
